...
using SuperBestFriends.Web.Models.CurrentUser;
...
namespace SuperBestFriends.Web.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,FirstName,LastName,BirthDate,Email,PhoneNumber,Interests")] User user)
        {
